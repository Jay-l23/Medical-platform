<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="订单编号" prop="purId">
        <el-input
    ...
    <el-table v-loading="loading" :data="purchaseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单编号" align="center" prop="purId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="订单编号" prop="purId">
          <el-input v-model="form.purId" placeholder="请输入订单编号" />
        </el-form-item>
        <el-form-item label="订单总额" prop="purCount">
...
:value="parseInt(dict.value)"
        ...
        <el-form-item label="供应商" prop="supName">
          <el-input v-model="form.supName" placeholder="请输入供应商" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除采购入库编号为"' + purIds + '"的数据项？').then(function() {
